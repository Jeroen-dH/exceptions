...
#vragenlijst 
naam = input("-----------------------------------------------------------\n Wat is uw naam?")
Dieren_dressuur = input("Heeft u 4 of meer jaar praktijk ervaring in dieren-dressuur?:\n-")
...
while manvrouw == 'man':
    snor2 = input("heeft u een snor breeder dan 10cm?:\n-")
while manvrouw == 'vrouw' :
    krul_haar2 = input("heeft i rood krulhaar?\n-")
